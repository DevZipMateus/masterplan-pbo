    ...
    <section className="py-16 bg-transparent overflow-hidden">
      <div className="container px-4 mx-auto max-w-6xl">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:gap-8 lg:gap-12 mb-10">
          ...
          <div className="md:w-1/2 rounded-xl overflow-hidden shadow-xl animate-fade-in border border-white/20">
        ...
        <div className="flex justify-center animate-fade-in">
          <a href={egestorLink} target="_blank" rel="noopener noreferrer" className="inline-block w-full max-w-sm">
            <button className="w-full py-3 bg-green-400 hover:bg-green-500 text-gray-800 font-medium rounded-full transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-[1.02] border border-green-300">
              Teste grátis
            </button>
          </a>
        </div>
