    ...
    <div className={`fixed ${isMobile ? 'bottom-4 right-4' : 'bottom-6 right-6'} z-50`}>
      ...
      <div className={`flex flex-col-reverse items-end mb-3 space-y-reverse space-y-2 transition-all duration-500 ${isOpen ? 'opacity-100 scale-100' : 'opacity-0 scale-95 pointer-events-none'}`}>
        <a 
          ...
          className="flex items-center bg-white text-primary px-4 py-3 rounded-lg shadow-lg hover:shadow-xl border border-primary/20 hover:bg-primary/5 transition-all duration-300 gap-3 font-medium group"
        ...
        >
          <Phone className="text-blue-500 group-hover:text-primary transition-colors" size={20} />
          <span className="group-hover:text-primary transition-colors">Telefone</span>
        </a>
        ...
        >
          <Mail className="text-red-500 group-hover:text-primary transition-colors" size={20} />
          <span className="group-hover:text-primary transition-colors">E-mail</span>
        </a>
      </div>
