        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="flex justify-between items-center h-16 sm:h-20 lg:h-24">
            ...
            <Link to="/" className="transition-all duration-300 transform hover:scale-[1.02] flex-shrink-0" aria-label="Ir para página inicial" onClick={handleScrollToTop}>
              <img src="/lovable-uploads/354a11e1-d640-47f9-8b73-a576dd2dcaad.png" alt="Masterplan BPO Financeiro - Soluções eficientes para gestão financeira" className="h-12 sm:h-16 lg:h-20 w-auto transition-all duration-300" />
            </Link>
