      ...
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="flex justify-between items-center h-16 sm:h-20 lg:h-24">
            {/* Logo - Responsive sizing with improved mobile responsiveness */}
            <Link to="/" className="transition-all duration-300 transform hover:scale-[1.02] flex-shrink-0" aria-label="Ir para página inicial" onClick={handleScrollToTop}>
              <img src="/lovable-uploads/d9796e93-d2bb-4c59-9858-2a31f9c0e391.png" alt="Masterplan BPO Financeiro - Soluções eficientes para gestão financeira" className="h-12 w-auto sm:h-16 md:h-20 lg:h-24 xl:h-28 transition-all duration-300" />
            </Link>
