        ...
        <div className="container mx-auto max-w-7xl flex justify-between items-center text-sm">
          <div className="flex items-center gap-6">
            <a 
              ...
              className="flex items-center gap-2 hover:text-masterplan-light-blue transition-colors"
            >
              <Mail size={16} />
      ...
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="flex justify-between items-center h-16 sm:h-20 lg:h-24">
            ...
            <Link 
              to="/" 
              className="transition-all duration-300 transform hover:scale-[1.02] flex-shrink-0" 
            ...
            >
              <img 
                ...
                className="h-12 sm:h-16 lg:h-20 w-auto transition-all duration-300" 
              />
            </Link>
            ...
            {/* Mobile Menu Button */}
            <button 
              className="lg:hidden text-masterplan-gray hover:text-primary focus:outline-none focus:ring-2 focus:ring-primary/50 rounded-md p-2 min-h-[44px] min-w-[44px] flex items-center justify-center" 
        ...
        <div className={`lg:hidden ${
          ...
          <nav className="container mx-auto px-4 py-4 flex flex-col space-y-1 border-t mt-2" role="navigation" aria-label="Menu mobile">
            <Link 
              to="/" 
              className="px-4 py-3 text-base text-masterplan-gray hover:text-primary hover:bg-gray-50 rounded-md transition-colors min-h-[44px] flex items-center" 
