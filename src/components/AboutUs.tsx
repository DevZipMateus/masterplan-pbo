...
const AboutUs = () => {
  return <section id="sobre" className="section bg-transparent">
      <div className="container-custom">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="lg:w-1/2">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-heading font-bold text-white mb-6 animate-fade-in" style={{
            animationDelay: '0.1s'
          }}>
            ...
            <div className="space-y-6 text-lg text-white/90 leading-relaxed animate-fade-in" style={{
            animationDelay: '0.2s'
          }}>
              <p>
          ...
          {/* Right Column - Values */}
          <div className="lg:w-1/2">
            <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-8 md:p-10 shadow-lg animate-fade-in border border-gray-200" style={{
            animationDelay: '0.4s'
          }}>
              ...
              <div className="space-y-6">
                {values.map((value, index) => <div key={value.title} className="flex items-start group animate-fade-in" style={{
        ...
        {/* Mission Statement */}
        <div className="mt-16 bg-gradient-to-r from-cyan-500 to-cyan-600 rounded-2xl p-8 md:p-12 text-center text-white shadow-lg animate-fade-in border border-cyan-400/30" style={{
        animationDelay: '0.8s'
      }}>
