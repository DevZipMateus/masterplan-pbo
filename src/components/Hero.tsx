...
const Hero = () => {
  ...
  return (
    <section className="pt-16 pb-12 sm:pt-20 sm:pb-16 md:pt-24 md:pb-20 lg:pt-32 lg:pb-24 relative overflow-hidden">
      {/* Background image */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="w-full max-w-4xl">
            ...
            <p className="text-base sm:text-lg md:text-xl mb-6 sm:mb-8 animate-fade-in text-gray-950 max-w-2xl mx-auto" style={{
              animationDelay: '0.2s'
            }}>
            ...
            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 animate-fade-in max-w-md mx-auto justify-center" style={{
              animationDelay: '0.4s'
            }}>
