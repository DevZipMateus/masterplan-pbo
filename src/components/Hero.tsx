      ...
      <div className="container-custom relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="lg:w-1/2 text-center lg:text-left">
            ...
            <p style={{
            animationDelay: '0.2s'
          }} className="text-lg md:text-xl mb-8 animate-fade-in text-gray-950">
            ...
            animationDelay: '0.4s'
              ...
              <a href="https://wa.me/5516997882208" target="_blank" rel="noopener noreferrer" className="bg-transparent hover:bg-white/10 text-black border border-black/30 px-6 py-3 rounded-lg transition-all duration-300 transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-black/50 shadow-sm font-medium inline-flex items-center justify-center" aria-label="Conhecer nossos serviços via WhatsApp">
                Nossos serviços
              </a>
            </div>
          </div>
